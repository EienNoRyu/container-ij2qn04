...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ij2qn04.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ij2qn04.containers.anotherwebservice.com/
...
```
git clone git@github.com:EienNoRyu/container-ij2qn04.git
cd container-ij2qn04
```
...
```
docker attach container-ij2qn04
```
